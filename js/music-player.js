(function () {
    const PLAYLIST = [
        { src: 'audio/track1.mp3', title: 'Em Mới Là Người Yêu Anh - MIN' },
        { src: 'audio/track2.mp3', title: 'Chỉ Một Đêm Nữa Thôi - RPT MCK' },
        { src: 'audio/track3.mp3', title: 'Anh Đã Quen Với Cô Đơn - SOOBIN Hoàng Sơn'},
        { src: 'audio/track4.mp3', title: 'In Love - LowG' },
    ];
